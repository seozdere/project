(function () {
    ...
    function ensureBanner() {
        ...
        banner.innerHTML = `
            <div style="flex:1;min-width:0;">
                <div style="font-weight:800;font-size:.92rem;">Uygulama gibi yükle</div>
                <div style="font-size:.78rem;opacity:.82;line-height:1.45;">Ana ekrana ekleyip tam ekran kullanabilirsiniz.</div>
            </div>
            <button id="codexPwaInstallBtn" style="border:none;border-radius:12px;padding:10px 14px;background:#fff;color:#1d4ed8;font-weight:800;cursor:pointer;">Yükle</button>
    ...
    window.addEventListener('beforeinstallprompt', event => {
        ...
        if (hint) hint.textContent = 'Bu sayfayı telefona uygulama gibi yükleyebilirsiniz.';
    });
